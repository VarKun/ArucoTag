...
# Default ArUco dictionary to use
...
def main(args):
    ...
    print("[INFO] detecting '{}' markers...".format(args["type"]))
    this_aruco_dictionary = cv2.aruco.getPredefinedDictionary(ARUCO_DICT[args["type"]])
    this_aruco_parameters = cv2.aruco.DetectorParameters()

    # Tweaking detection parameters for better accuracy
